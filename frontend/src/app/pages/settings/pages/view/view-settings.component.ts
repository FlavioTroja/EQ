...
@Component({
  ...
  standalone: true,
  imports: [ CommonModule, ShowImageComponent, MatIconModule ],
  template: `
    <div class="flex flex-col gap-2">
      ...
      <div (click)="navigateToUsers()" class="flex items-center justify-between text-md bg-foreground rounded-md p-3 cursor-pointer default-shadow">
