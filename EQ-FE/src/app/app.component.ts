    ...
    <div class="h-screen w-screen bg-main overflow-hidden relative">
      <div class="grid grid-cols-[min-content_auto] z-10">
        ...
        <div class="relative w-full overflow-x-auto">
          ...
          <div class="px-3.5 pt-[4.75rem] overflow-y-scroll h-screen z-10 relative -m-1 p-1"  [ngStyle]="{'padding-bottom': !isDesktop ? 'calc(66px + 12rem)' : ''}">
...
export class AppComponent {
  ...
  handleNavbarButtonClick({ action, navigate, dialog }: { action: string, navigate?: string, dialog?: NavBarButtonDialog<any, any> }) {
    if(navigate) {
