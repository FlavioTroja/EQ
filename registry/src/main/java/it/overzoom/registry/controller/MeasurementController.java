...
public class MeasurementController {
    ...
    @PostMapping("")
    public ResponseEntity<Measurement> create(@PathVariable(value = "sourceId") String sourceId,
    ...
    public ResponseEntity<Measurement> partialUpdate(@PathVariable(value = "id") String id,
