...
/** component for a custom pill with icon and onClick event */
@Component({
  selector: 'app-hyper-pill',
  standalone: true,
  imports: [CommonModule, MatIconModule, MatTooltipModule],
  template: `
    <div class="bg-foreground default-shadow rounded-full max-w-max px-2 py-1.5 flex gap-1 items-center break-keep cursor-pointer"
         (click)="handleOnClick()"
...
export class HyperPillComponent {
  /** identifier of the single component in case of onClick event */
