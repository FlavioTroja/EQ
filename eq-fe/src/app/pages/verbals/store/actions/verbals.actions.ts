...
import { PartialVerbal, Verbal } from "../../../../models/Verbal";
...
export const addVerbalSuccess = createAction("[Verbals] Add verbal Success", props<{ verbal: Verbal }>());
...
export const getVerbalSuccess = createAction("[Verbals] Get verbal Success", props<{ current: Verbal }>());
...
export const editVerbalSuccess = createAction("[Verbals] Edit verbal Success", props<{ verbal: Verbal }>());
...
export const deleteVerbalSuccess = createAction("[Verbals] Delete verbal Success", props<{ verbal: Verbal }>());
...
export const loadVerbalsSuccess = createAction("[Verbals] Load Success", props<{ verbals: PaginateDatasource<Verbal> }>());
