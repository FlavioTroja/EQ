...
export const getMachine = createAction("[Machines] Get", props<{ id: number, params?: DefaultQueryParams }>());
...
export const deleteMachine = createAction("[Machines] Delete", props<{ id: number }>());
