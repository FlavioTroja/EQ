...
import { LoginPayload, Auth, RegisterPayload } from "../../../models/Auth";
...
export const register = createAction("[Auth] Register", props<RegisterPayload>());
export const registerSuccess = createAction("[Auth] Register Success", props<{ auth: Auth }>());
export const registerFailed = createAction("[Auth] Register Failed", props<{ error: HttpError }>());
